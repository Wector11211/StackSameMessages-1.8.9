...
public class UncoloredModTextField extends Gui {
    ...
    public UncoloredModTextField(int componentId, FontRenderer fontrenderer, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
